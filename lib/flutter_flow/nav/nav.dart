...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? EnteryWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'InviteUserChat',
              path: 'inviteUserChat',
              builder: (context, params) => InviteUserChatWidget(),
            ),
            FFRoute(
              name: 'test123',
              path: 'test123',
            ...
            FFRoute(
              name: 'HomePage3_final',
              path: 'homePage3Final',
              builder: (context, params) => HomePage3FinalWidget(),
            ),
            FFRoute(
              name: 'GameCopy',
              path: 'gameCopy',
              builder: (context, params) => GameCopyWidget(
                category: params.getParam('category', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'CreateGame2',
              path: 'createGame2',
              builder: (context, params) => CreateGame2Widget(
                title: params.getParam('title', ParamType.String),
            ...
            FFRoute(
              name: 'CreateGame3',
              path: 'createGame3',
              builder: (context, params) => CreateGame3Widget(
                title: params.getParam('title', ParamType.String),
                startDate: params.getParam('startDate', ParamType.DateTime),
                endDate: params.getParam('endDate', ParamType.DateTime),
                round: params.getParam('round', ParamType.int),
                recruitNum: params.getParam('recruitNum', ParamType.int),
              ),
            ),
            FFRoute(
              name: 'Entery',
              path: 'entery',
              builder: (context, params) => EnteryWidget(),
            )

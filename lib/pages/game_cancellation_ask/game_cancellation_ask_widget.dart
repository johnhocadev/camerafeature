...
import 'game_cancellation_ask_model.dart';
export 'game_cancellation_ask_model.dart';

class GameCancellationAskWidget extends StatefulWidget {
  const GameCancellationAskWidget({
    Key? key,
    this.contestref,
  }) : super(key: key);
  ...
  @override
  _GameCancellationAskWidgetState createState() =>
      _GameCancellationAskWidgetState();
}

class _GameCancellationAskWidgetState extends State<GameCancellationAskWidget> {
  late GameCancellationAskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameCancellationAskModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ContestRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final gameCancellationAskContestRecord = snapshot.data!;
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Align(
                                  ...
                                  child: Text(
                                    gameCancellationAskContestRecord.title,

                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if (FFAppState().join == false)
                                      FFButtonWidget(
                                        onPressed: () async {
                                          setState(() {
                                            FFAppState().join = true;
                                          });
                                          if (isiOS) {
                                            await launchUrl(Uri.parse(
                                                "sms:_model.textController3.text&body=${Uri.encodeComponent(random_data.randomInteger(1000, 9999).toString())}"));
                                          } else {
                                            await launchUrl(Uri(
                                              scheme: 'sms',
                                              path: _model.textController3.text,
                            ...
                            onPressed: () async {
                              ...
                              await UsersRecord.collection
                                  ...
                                  .update(createUsersRecordData(
                                    ...
                                    uid: _model.emailTextController.text,
                              ...
                              FFAppState().update(() {
                                FFAppState()
                                    .addToUserdata(currentUserReference!);
                              });

                              context.goNamedAuth('Entery', context.mounted);
                            },
                            text: '회원가입',
                            options: FFButtonOptions(
                              width: 120.0,

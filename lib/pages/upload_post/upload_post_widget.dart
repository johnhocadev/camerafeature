  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PostRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PostRecord> uploadPostPostRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final uploadPostPostRecord = uploadPostPostRecordList.isNotEmpty
            ? uploadPostPostRecordList.first
            : null;
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    height: MediaQuery.sizeOf(context).height * 0.943,
                ...
                StreamBuilder<List<DisplayRecord>>(
                  stream: queryDisplayRecord(
                    singleRecord: true,
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    ...
                    List<DisplayRecord> buttonDisplayRecordList =
                        snapshot.data!;
                    // Return an empty Container when the item does not exist.
                    if (snapshot.data!.isEmpty) {
                      return Container();
                    }
                    final buttonDisplayRecord =
                        buttonDisplayRecordList.isNotEmpty
                            ? buttonDisplayRecordList.first
                            : null;
                    return FFButtonWidget(
                      onPressed: () async {
                        if ((_model.textController1.text != null &&
                            ...
                            (_model.textController13.text != null &&
                                _model.textController13.text != '') &&
                            (_model.textController14.text != null &&
                                _model.textController14.text != '') &&
                            (_model.isDataUploading != null)) {
                          await PostRecord.collection.doc().set({
                            ...createPostRecordData(
                              fishtype: _model.textController1.text,
                              date: _model.datePicked1,
                              watertime: _model.datePicked2,
                              fishingplace: _model.textController4.text,
                              location: _model.textController5.text,
                              title: _model.textController13.text,
                              contents: uploadPostPostRecord!.contents,
                              userref: currentUserReference,
                              notice: false,
                              createtime: getCurrentTimestamp,
                              postType: _model.dropDownValue,
                              partner: _model.textController6.text,
                              rod: _model.textController7.text,
                              float: _model.textController8.text,
                              fishingLine: _model.textController9.text,
                              needle: _model.textController10.text,
                              bait: _model.textController11.text,
                              technique: _model.textController12.text,
                            ),
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: AlartWidget(
                                      ...
                                      contents:
                                          '이미지와 모든 내용을 빠짐 없이 입력해야 게시글 업로드가 가능합니다.',
                                      button: '확인',
                                    ),
                                  ),
                                ),
                        ...
                        if (uploadPostPostRecord!.postType == '바다 조행기') {
                          await buttonDisplayRecord!.reference
                              .update(createDisplayRecordData(
                            post1: uploadPostPostRecord!.reference,
                          ));
                        } else {
                          if (uploadPostPostRecord!.postType == '민물 조행기') {
                            await buttonDisplayRecord!.reference
                                .update(createDisplayRecordData(
                              post1: uploadPostPostRecord!.reference,
                            ));
                            ...
                            await buttonDisplayRecord!.reference
                                .update(createDisplayRecordData(
                              post2: uploadPostPostRecord!.reference,
                            ));
                          }
                        }

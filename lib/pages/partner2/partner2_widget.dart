...
import 'partner2_model.dart';
export 'partner2_model.dart';

class Partner2Widget extends StatefulWidget {
  const Partner2Widget({Key? key}) : super(key: key);

  @override
  _Partner2WidgetState createState() => _Partner2WidgetState();
}

class _Partner2WidgetState extends State<Partner2Widget> {
  late Partner2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Partner2Model());
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Padding(
                                                                                          padding: EdgeInsetsDirectional.fromSTEB(0.0, 7.0, 0.0, 0.0),
                                                                                          child: Text(
                                                                                            columnShipRecord.costmoney.toString(),
                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                                  color: FlutterFlowTheme.of(context).maincolor,
                                                                                                  fontSize: 13.0,
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Image
                                                                      ...
                                                                      valueOrDefault<
                                                                          String>(
                                                                        columnFishingzone2Record.image.first != null &&
                                                                                columnFishingzone2Record.image.first != ''
                                                                            ? columnFishingzone2Record.image.first
                                                                            : 'https://tong.visitkorea.or.kr/cms/resource/60/1575760_image2_1.jpg',
                                                                        'https://tong.visitkorea.or.kr/cms/resource/60/1575760_image2_1.jpg',
                                                                      ),
                                                                      width:
                                                                          100.0,
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        columnFishingzone2Record.address,
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                    ...
                                                                                    child: Wrap(
                                                                                      ...
                                                                                      children: [
                                                                                        Padding(
                                                                                          padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 5.0, 0.0),
                                                                                          child: Text(
                                                                                            columnFishingzone2Record.mainFish,
                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                                  color: FlutterFlowTheme.of(context).maincolor,
                                                                                                  fontSize: 12.0,
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child: Image
                                                                        ...
                                                                        valueOrDefault<
                                                                          ...
                                                                          columnContest2Record
                                                                              .image,
                                                                          'https://envato-shoebox-0.imgix.net/1fb5/67da-a37f-11e4-b32a-b8ca3a6774f8/Highland+Cows+080p%283%29.jpg?auto=compress%2Cformat&fit=max&mark=https%3A%2F%2Felements-assets.envato.com%2Fstatic%2Fwatermark2.png&markalign=center%2Cmiddle&markalpha=18&w=800&s=c0c52b64c643a242ebda25eed96f592d',
                                                                        ),
                                                                        fit: BoxFit
                                                                            .cover,
                                                                      ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Text(
                                                                                valueOrDefault<String>(
                                                                                  columnContest2Record.startDate?.toString(),
                                                                                  '-',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                              ...
                                                                              Text(
                                                                                valueOrDefault<String>(
                                                                                  columnContest2Record.endDate?.toString(),
                                                                                  '-',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                '${columnLodgeRecord.cost.toString()}원',
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
                                                                                      color: FlutterFlowTheme.of(context).primaryText,
                                                                                      fontSize: 16.0,

...
import 'my_post_review_model.dart';
export 'my_post_review_model.dart';

class MyPostReviewWidget extends StatefulWidget {
  const MyPostReviewWidget({
    Key? key,
    this.mypost,
  }) : super(key: key);
  ...
  @override
  _MyPostReviewWidgetState createState() => _MyPostReviewWidgetState();
}

class _MyPostReviewWidgetState extends State<MyPostReviewWidget> {
  late MyPostReviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyPostReviewModel());

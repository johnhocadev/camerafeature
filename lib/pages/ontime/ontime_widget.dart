...
import 'ontime_model.dart';
export 'ontime_model.dart';

class OntimeWidget extends StatefulWidget {
  const OntimeWidget({Key? key}) : super(key: key);

  @override
  _OntimeWidgetState createState() => _OntimeWidgetState();
}
                          ...
                          StreamBuilder<List<Fishingzone2Record>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<Fishingzone2Record>
                                  pageViewFishingzone2RecordList =
                                  snapshot.data!;
                              return Container(
                                ...
                                child: PageView.builder(
                                  ...
                                  itemCount:
                                      pageViewFishingzone2RecordList.length,
                                  itemBuilder: (context, pageViewIndex) {
                                    final pageViewFishingzone2Record =
                                        pageViewFishingzone2RecordList[
                                            pageViewIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            AutoSizeText(
                                                                              pageViewFishingzone2Record.fee.maybeHandleOverflow(
                                                                                maxChars: 15,
                                                                                replacement: '…',
                                                                              ),
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              AutoSizeText(
                                                                            pageViewFishingzone2Record.address != null && pageViewFishingzone2Record.address != ''
                                                                                ? pageViewFishingzone2Record.address
                                                                                : pageViewFishingzone2Record.address2,
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  fontFamily: FlutterFlowTheme.of(context).bodyMediumFamily,
            ...
            Material(
              ...
              child: Container(
                ...
                child: wrapWithModel(
                  ...
                  child: NaviWidget(
                    c2: FlutterFlowTheme.of(context).maincolor,
                    b1: false,
                    b2: true,
                    b3: false,
                    b4: false,

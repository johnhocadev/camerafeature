...
class _PlaceDetailWidgetState extends State<PlaceDetailWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<Fishingzone2Record>(
      ...
      builder: (context, snapshot) {
        ...
        final placeDetailFishingzone2Record = snapshot.data!;
                                    ...
                                    Padding(
                                      ...
                                      child: SelectionArea(
                                        ...
                                        valueOrDefault<String>(
                                          placeDetailFishingzone2Record.name,
                                          '-',
                                        ),
                            ...
                            child: Stack(
                              children: [
                                Builder(
                                  builder: (context) {
                                    final imageList =
                                        placeDetailFishingzone2Record.image
                                            .toList();
                                    return Container(
                                                            ...
                                                            children: [
                                                              Padding(
                                                                ...
                                                                child: Text(
                                                                  valueOrDefault<
                                                                      String>(
                                                                    placeDetailFishingzone2Record.capacity !=
                                                                            null
                                                                        ? '수용 가능인원 : ${valueOrDefault<String>(
                                                                            formatNumber(
                                                                              placeDetailFishingzone2Record.capacity,
                  ...
                  onTap: () async {
                    await launchUrl(Uri(
                      ...
                      path: valueOrDefault<String>(
                        placeDetailFishingzone2Record.phoneNum,
                        '-',
                      ),
                    ));
                  },

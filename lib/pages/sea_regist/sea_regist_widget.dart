...
import 'sea_regist_model.dart';
export 'sea_regist_model.dart';

class SeaRegistWidget extends StatefulWidget {
  const SeaRegistWidget({Key? key}) : super(key: key);

  @override
  _SeaRegistWidgetState createState() => _SeaRegistWidgetState();
}

class _SeaRegistWidgetState extends State<SeaRegistWidget> {
  late SeaRegistModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeaRegistModel());
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Text(
                                            '바다 등록 시 유의사항을 확인해 주시고 피싱존 바다 업로드 규정에 동의해 주세요.',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily:
                                  ...
                                  if ((_model.checkboxValue1 == true) &&
                                    ...
                                    await Fishingzone2Record.collection
                                      ...
                                      ...createFishingzone2RecordData(
                                        ...
                                        uploadUser: currentUserReference?.id,

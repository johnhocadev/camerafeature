                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                                queryRankRecord(
                                                                              queryBuilder: (rankRecord) => rankRecord.where('postType', isEqualTo: '바다 랭킹'),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                                queryRankRecord(
                                                                              queryBuilder: (rankRecord) => rankRecord.where('postType', isEqualTo: '바다 랭킹').where('fish', isEqualTo: FFAppState().rank).orderBy('length', descending: true),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                                queryRankRecord(
                                                                              queryBuilder: (rankRecord) => rankRecord.where('postType', isEqualTo: '민물 랭킹'),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                                queryRankRecord(
                                                                              queryBuilder: (rankRecord) => rankRecord.where('postType', isEqualTo: '민물 랭킹').where('fish', isEqualTo: FFAppState().rank2).orderBy('length', descending: true),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.

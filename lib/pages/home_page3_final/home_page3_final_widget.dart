...
import 'home_page3_final_model.dart';
export 'home_page3_final_model.dart';

class HomePage3FinalWidget extends StatefulWidget {
  const HomePage3FinalWidget({Key? key}) : super(key: key);

  @override
  _HomePage3FinalWidgetState createState() => _HomePage3FinalWidgetState();
}

class _HomePage3FinalWidgetState extends State<HomePage3FinalWidget> {
  late HomePage3FinalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePage3FinalModel());
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Container(
                                                                                          ...
                                                                                          child: Padding(
                                                                                            ...
                                                                                            child: AutoSizeText(
                                                                                              valueOrDefault<String>(
                                                                                                rowFishingzone2Record.mainFish,
                                                                                                '-',
                                                                                              ).maybeHandleOverflow(
                                                                                                maxChars: 10,
                                                                                                replacement: '…',

...
import 'otheruser_model.dart';
export 'otheruser_model.dart';
...
class OtheruserWidget extends StatefulWidget {
  ...
  @override
  _OtheruserWidgetState createState() => _OtheruserWidgetState();
}

class _OtheruserWidgetState extends State<OtheruserWidget> {
  late OtheruserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtheruserModel());
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText:
                                            otheruserUsersRecord.fishingGrounds,
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                              fontFamily:
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final fishList = otheruserUsersRecord
                                            .likeFish
                                            .toList();
                                        return SingleChildScrollView(
                                          ...
                                          child: Row(
                                            ...
                                            children:
                                                List.generate(fishList.length,
                                                    (fishListIndex) {
                                              final fishListItem =
                                                  fishList[fishListIndex];
                                              return Align(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        hintText: otheruserUsersRecord.topLank,
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
                                              fontFamily:
                        ...
                        builder: (context, snapshot) {
                          ...
                          return Column(
                            ...
                            children: List.generate(columnPostRecordList.length,
                              ...
                              return Visibility(
                                visible: (columnPostRecord.userref ==
                                            widget.userref) ==
                                        true
                                    ? true
                                    : false,

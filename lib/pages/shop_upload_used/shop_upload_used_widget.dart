...
import 'shop_upload_used_model.dart';
export 'shop_upload_used_model.dart';

class ShopUploadUsedWidget extends StatefulWidget {
  const ShopUploadUsedWidget({Key? key}) : super(key: key);

  @override
  _ShopUploadUsedWidgetState createState() => _ShopUploadUsedWidgetState();
}

class _ShopUploadUsedWidgetState extends State<ShopUploadUsedWidget> {
  late ShopUploadUsedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopUploadUsedModel());
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: StreamBuilder<List<UsedRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<UsedRecord> columnUsedRecordList = snapshot.data!;
              // Return an empty Container when the item does not exist.
              if (snapshot.data!.isEmpty) {
                return Container();
              }
              final columnUsedRecord = columnUsedRecordList.isNotEmpty
                  ? columnUsedRecordList.first
                  : null;
              return Column(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if ((_model.isDataUploading1 != null) &&
                                    ...
                                    await UsedRecord.collection.doc().set({

...
import 'shop_upload_ticket_model.dart';
export 'shop_upload_ticket_model.dart';

class ShopUploadTicketWidget extends StatefulWidget {
  const ShopUploadTicketWidget({Key? key}) : super(key: key);

  @override
  _ShopUploadTicketWidgetState createState() => _ShopUploadTicketWidgetState();
}

class _ShopUploadTicketWidgetState extends State<ShopUploadTicketWidget> {
  late ShopUploadTicketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopUploadTicketModel());
    ...
    _model.textController8 ??= TextEditingController(
        text: _model.datePicked3 != null
            ...
            : '');
    _model.textField6Controller ??= TextEditingController();
    _model.textField7Controller ??= TextEditingController();
    _model.textField8Controller ??= TextEditingController();
    ...
    _model.textField9Controller ??= TextEditingController();
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  hintText:
                                                      '매장 이용 시간과 금액, 정기휴무일, 주의사항, 안내사항 편의시설 등을 입력',
                                                  hintStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .bodySmall
                                                      .override(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller:
                                                    _model.textField5Controller,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  hintText: '지역 입력 ex) 경기도 성남시',
                                                  hintStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .bodySmall
                                                      .override(
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      '최대 5개까지 입력 가능하며 1개 이상은 필수 등록, 원가는 표시되지 않으나 할인가 표시를 위해 수집합니다.',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                controller: _model.textField9Controller,
                                obscureText: false,
                                decoration: InputDecoration(
                                  hintText: '티켓 상세 안내를 입력해 주세요',
                                ...
                                maxLines: 20,
                                validator: _model.textField9ControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if ((_model.isDataUploading1 != null) &&
                                  (_model.textField1Controller.text != null &&
                                  ...
                                  (_model.textField5Controller.text != null &&
                                      _model.textField5Controller.text != '') &&
                                  (_model.textField6Controller.text != null &&
                                      _model.textField6Controller.text != '') &&
                                  (_model.textField7Controller.text != null &&
                                      _model.textField7Controller.text != '') &&
                                  (_model.textField8Controller.text != null &&
                                      _model.textField8Controller.text != '') &&
                                  (_model.textField9Controller.text != null &&
                                      _model.textField9Controller.text != '') &&
                                  (_model.datePicked1 != null) &&
                                  (_model.datePicked2 != null)) {
                                await TicketRecord.collection.doc().set({
                                  ...createTicketRecordData(
                                    uploadUser: currentUserReference,
                                    title: _model.textField1Controller.text,
                                    businessStart: _model.datePicked1,
                                    businessEnd: _model.datePicked2,
                                    reservePer: _model.countControllerValue,
                                    call: _model.textField3Controller.text,
                                    manufacture:
                                        _model.textField4Controller.text,
                                    ...
                                    specialPrice1: int.tryParse(
                                        _model.textField7Controller.text),
                                    specialPrice2: int.tryParse(
                                        _model.textController13.text),
                                    specialPrice3: int.tryParse(
                                        _model.textController16.text),
                                    specialPrice4: int.tryParse(
                                        _model.textController19.text),
                                    specialPrice5: int.tryParse(
                                        _model.textController22.text),
                                    productInfo:
                                        _model.textField9Controller.text,
                                    businessDetail:
                                        _model.textField2Controller.text,
                                    area: _model.textField5Controller.text,
                                    originalP1: int.tryParse(
                                        _model.textField8Controller.text),
                                    originalP2: int.tryParse(
                                        _model.textController14.text),
                                    originalP3: int.tryParse(
                                        _model.textController17.text),
                                    originalP4: int.tryParse(
                                        _model.textController20.text),
                                    originalP5: int.tryParse(
                                        _model.textController23.text),
                                    eventEndDate: _model.datePicked3,
                                    ...
                                    return GestureDetector(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: SuccessWidget(
                                            title: '상품이 등록되었습니다.',
                                            contents: '등록된 상품은 피싱샵에서 확인 가능합니다.',
                                            button: '확인',
                                          ),
                                        ),
                                      ),

...
import 'sendmail_model.dart';
export 'sendmail_model.dart';
...
class _SendmailWidgetState extends State<SendmailWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendmailModel());

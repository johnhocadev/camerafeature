...
import 'contest_date_select_check_model.dart';
export 'contest_date_select_check_model.dart';

class ContestDateSelectCheckWidget extends StatefulWidget {
  const ContestDateSelectCheckWidget({
    Key? key,
    this.contestref,
  }) : super(key: key);
  ...
  @override
  _ContestDateSelectCheckWidgetState createState() =>
      _ContestDateSelectCheckWidgetState();
}

class _ContestDateSelectCheckWidgetState
    extends State<ContestDateSelectCheckWidget> {
  late ContestDateSelectCheckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContestDateSelectCheckModel());

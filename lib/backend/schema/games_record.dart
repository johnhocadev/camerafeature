...
class GamesRecord extends FirestoreRecord {
  ...
  // "answerd_questions" field.
  List<int>? _answerdQuestions;
  List<int> get answerdQuestions => _answerdQuestions ?? const [];
  bool hasAnswerdQuestions() => _answerdQuestions != null;
  ...
  void _initializeFields() {
    ...
    _answerdQuestions = getDataList(snapshotData['answerd_questions']);
  }
...
class GamesRecordDocumentEquality implements Equality<GamesRecord> {
  ...
  bool equals(GamesRecord? e1, GamesRecord? e2) {
    ...
    return e1?.code == e2?.code &&
        ...
        listEquality.equals(e1?.answerdQuestions, e2?.answerdQuestions);
  }

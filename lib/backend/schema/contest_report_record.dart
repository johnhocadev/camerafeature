...
class ContestReportRecordDocumentEquality
    implements Equality<ContestReportRecord> {
  const ContestReportRecordDocumentEquality();

  @override
  bool equals(ContestReportRecord? e1, ContestReportRecord? e2) {
  ...
  @override
  int hash(ContestReportRecord? e) => const ListEquality().hash([
        e?.date,
        e?.type,
        e?.title,
        e?.contents,
  ...
  @override
  bool isValidKey(Object? o) => o is ContestReportRecord;
}

...
class ShopReviewRecordDocumentEquality implements Equality<ShopReviewRecord> {
  const ShopReviewRecordDocumentEquality();

  @override
  bool equals(ShopReviewRecord? e1, ShopReviewRecord? e2) {
    return e1?.shopref == e2?.shopref &&
        e1?.postedUser == e2?.postedUser &&
        e1?.image == e2?.image &&
        e1?.title == e2?.title &&
        ...
        e1?.star2 == e2?.star2 &&
        e1?.star3 == e2?.star3 &&
        e1?.starAll == e2?.starAll;
  }

  @override
  int hash(ShopReviewRecord? e) => const ListEquality().hash([
        e?.shopref,
        e?.postedUser,
        e?.image,
        e?.title,
  ...
  @override
  bool isValidKey(Object? o) => o is ShopReviewRecord;
}

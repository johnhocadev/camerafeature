...
class MapapisampleRecordDocumentEquality
    implements Equality<MapapisampleRecord> {
  const MapapisampleRecordDocumentEquality();

  @override
  bool equals(MapapisampleRecord? e1, MapapisampleRecord? e2) {
    return e1?.api == e2?.api && e1?.placename == e2?.placename;
  }

  @override
  int hash(MapapisampleRecord? e) =>
      const ListEquality().hash([e?.api, e?.placename]);

  @override
  bool isValidKey(Object? o) => o is MapapisampleRecord;
}

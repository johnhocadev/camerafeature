...
class ContestRecordDocumentEquality implements Equality<ContestRecord> {
  const ContestRecordDocumentEquality();

  @override
  bool equals(ContestRecord? e1, ContestRecord? e2) {
    const listEquality = ListEquality();
    return e1?.contestType == e2?.contestType &&
        e1?.title == e2?.title &&
        e1?.area == e2?.area &&
        e1?.locationDetail == e2?.locationDetail &&
        e1?.call == e2?.call &&
        e1?.rules == e2?.rules &&
        e1?.hookNumber == e2?.hookNumber &&
        e1?.rules2 == e2?.rules2 &&
        e1?.fishingline == e2?.fishingline &&
        e1?.bait == e2?.bait &&
        e1?.fishingHook == e2?.fishingHook &&
        e1?.parking == e2?.parking &&
        e1?.lodge == e2?.lodge &&
        e1?.image == e2?.image &&
        e1?.detailContents == e2?.detailContents &&
        e1?.time1 == e2?.time1 &&
        e1?.time2 == e2?.time2 &&
        e1?.time3 == e2?.time3 &&
        e1?.time4 == e2?.time4 &&
        ...
        listEquality.equals(e1?.appliedUser, e2?.appliedUser) &&
        e1?.fishType == e2?.fishType &&
        e1?.rod == e2?.rod &&
        e1?.recruitNum == e2?.recruitNum &&
        e1?.step == e2?.step &&
        e1?.morebutton == e2?.morebutton &&
        e1?.modifyScoreCompany == e2?.modifyScoreCompany &&
        e1?.modifyScoreUser == e2?.modifyScoreUser &&
        e1?.corruption == e2?.corruption &&
        e1?.report == e2?.report &&
        listEquality.equals(e1?.appliedUserName, e2?.appliedUserName) &&
        listEquality.equals(e1?.players, e2?.players) &&
        e1?.totalroundnumber == e2?.totalroundnumber &&
        listEquality.equals(e1?.totalRoundData, e2?.totalRoundData) &&
        e1?.contestDateEnd == e2?.contestDateEnd &&
        e1?.contestDate == e2?.contestDate &&
        e1?.endDate == e2?.endDate &&
        e1?.startDate == e2?.startDate &&
        e1?.gameFished == e2?.gameFished &&
        e1?.create == e2?.create;
  }

  @override
  int hash(ContestRecord? e) => const ListEquality().hash([
        e?.contestType,
        e?.title,
        e?.area,
        e?.locationDetail,
  ...
  @override
  bool isValidKey(Object? o) => o is ContestRecord;
}

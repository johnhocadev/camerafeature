...
class TicketReviewRecordDocumentEquality
    implements Equality<TicketReviewRecord> {
  const TicketReviewRecordDocumentEquality();

  @override
  bool equals(TicketReviewRecord? e1, TicketReviewRecord? e2) {
  ...
  @override
  int hash(TicketReviewRecord? e) => const ListEquality().hash([
        e?.ticket,
        e?.uploadUser,
        e?.image,
        e?.title,
  ...
  @override
  bool isValidKey(Object? o) => o is TicketReviewRecord;
}

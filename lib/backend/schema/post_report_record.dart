...
class PostReportRecordDocumentEquality implements Equality<PostReportRecord> {
  const PostReportRecordDocumentEquality();

  @override
  bool equals(PostReportRecord? e1, PostReportRecord? e2) {
    const listEquality = ListEquality();
    return e1?.reportedUser == e2?.reportedUser &&
        ...
        e1?.image == e2?.image &&
        e1?.replyType == e2?.replyType &&
        e1?.replyTime == e2?.replyTime &&
        listEquality.equals(e1?.replycontents, e2?.replycontents) &&
        e1?.recommendref == e2?.recommendref;
  }

  @override
  int hash(PostReportRecord? e) => const ListEquality().hash([
        e?.reportedUser,
        e?.postref,
        e?.reportTime,
        e?.type,
  ...
  @override
  bool isValidKey(Object? o) => o is PostReportRecord;
}

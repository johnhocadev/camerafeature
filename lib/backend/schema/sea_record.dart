...
class SeaRecordDocumentEquality implements Equality<SeaRecord> {
  const SeaRecordDocumentEquality();

  @override
  bool equals(SeaRecord? e1, SeaRecord? e2) {
    ...
    return e1?.title == e2?.title &&
        ...
        e1?.shipscale == e2?.shipscale &&
        e1?.peoplelimit == e2?.peoplelimit &&
        e1?.seats == e2?.seats &&
        listEquality.equals(e1?.heart, e2?.heart) &&
        e1?.location == e2?.location &&
        e1?.latlng == e2?.latlng &&
        e1?.intro == e2?.intro &&
        e1?.frontimage == e2?.frontimage &&
        e1?.bank == e2?.bank &&
        e1?.accountholder == e2?.accountholder &&
        e1?.bankaccountnum == e2?.bankaccountnum &&
        listEquality.equals(e1?.commentsref, e2?.commentsref) &&
        listEquality.equals(e1?.costlist, e2?.costlist) &&
        listEquality.equals(e1?.costmoneylist, e2?.costmoneylist) &&
  ...
  @override
  int hash(SeaRecord? e) => const ListEquality().hash([
        e?.title,
        e?.image,
        e?.sailingstart,
        e?.sailingend,
  ...
  @override
  bool isValidKey(Object? o) => o is SeaRecord;
}

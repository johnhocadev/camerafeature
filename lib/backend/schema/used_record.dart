...
class UsedRecordDocumentEquality implements Equality<UsedRecord> {
  const UsedRecordDocumentEquality();

  @override
  bool equals(UsedRecord? e1, UsedRecord? e2) {
    const listEquality = ListEquality();
    return listEquality.equals(e1?.imagelist, e2?.imagelist) &&
        e1?.productname == e2?.productname &&
        e1?.price == e2?.price &&
        e1?.negotiation == e2?.negotiation &&
  ...
  @override
  int hash(UsedRecord? e) => const ListEquality().hash([
        e?.imagelist,
        e?.productname,
        e?.price,
        e?.negotiation,
  ...
  @override
  bool isValidKey(Object? o) => o is UsedRecord;
}

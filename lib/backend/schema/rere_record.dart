...
class RereRecordDocumentEquality implements Equality<RereRecord> {
  const RereRecordDocumentEquality();

  @override
  bool equals(RereRecord? e1, RereRecord? e2) {
    return e1?.commentsref == e2?.commentsref &&
  ...
  @override
  int hash(RereRecord? e) => const ListEquality()
      .hash([e?.commentsref, e?.uploadUser, e?.uploadTime, e?.txt, e?.postref]);

  @override
  bool isValidKey(Object? o) => o is RereRecord;
}

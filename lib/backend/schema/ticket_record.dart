...
class TicketRecordDocumentEquality implements Equality<TicketRecord> {
  ...
  bool equals(TicketRecord? e1, TicketRecord? e2) {
    ...
    return listEquality.equals(e1?.image, e2?.image) &&
        ...
        e1?.title == e2?.title &&
        e1?.businessStart == e2?.businessStart &&
        e1?.businessEnd == e2?.businessEnd &&
        e1?.reservePer == e2?.reservePer &&
        listEquality.equals(e1?.reservePerRef, e2?.reservePerRef) &&
        e1?.rating == e2?.rating &&
        e1?.call == e2?.call &&
        e1?.manufacture == e2?.manufacture &&
        e1?.detailImage == e2?.detailImage &&
        listEquality.equals(e1?.reviewRef, e2?.reviewRef) &&
        e1?.specialPriceT1 == e2?.specialPriceT1 &&
        e1?.specialPriceT2 == e2?.specialPriceT2 &&
        e1?.specialPriceT3 == e2?.specialPriceT3 &&
        e1?.specialPriceT4 == e2?.specialPriceT4 &&
        e1?.specialPriceT5 == e2?.specialPriceT5 &&
        e1?.specialPrice1 == e2?.specialPrice1 &&
        e1?.specialPrice2 == e2?.specialPrice2 &&
        e1?.specialPrice3 == e2?.specialPrice3 &&
        e1?.specialPrice4 == e2?.specialPrice4 &&
        e1?.specialPrice5 == e2?.specialPrice5 &&
        e1?.productInfo == e2?.productInfo &&
        e1?.businessDetail == e2?.businessDetail &&
        e1?.area == e2?.area &&
        e1?.originalP1 == e2?.originalP1 &&
        e1?.originalP2 == e2?.originalP2 &&
        e1?.originalP3 == e2?.originalP3 &&
        e1?.originalP4 == e2?.originalP4 &&
        e1?.originalP5 == e2?.originalP5 &&
        e1?.soldout == e2?.soldout &&
        e1?.eventEndDate == e2?.eventEndDate &&
        e1?.uploadDate == e2?.uploadDate &&
        listEquality.equals(e1?.ticketList, e2?.ticketList) &&

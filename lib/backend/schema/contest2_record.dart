...
class Contest2RecordDocumentEquality implements Equality<Contest2Record> {
  const Contest2RecordDocumentEquality();

  @override
  bool equals(Contest2Record? e1, Contest2Record? e2) {
    ...
    return e1?.contestType == e2?.contestType &&
        ...
        e1?.sponsorGoods == e2?.sponsorGoods &&
  ...
  @override
  int hash(Contest2Record? e) => const ListEquality().hash([
        e?.contestType,
        e?.title,
        e?.startDate,
        e?.endDate,
  ...
  @override
  bool isValidKey(Object? o) => o is Contest2Record;
}

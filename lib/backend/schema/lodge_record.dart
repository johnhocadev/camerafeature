...
class LodgeRecordDocumentEquality implements Equality<LodgeRecord> {
  const LodgeRecordDocumentEquality();

  @override
  bool equals(LodgeRecord? e1, LodgeRecord? e2) {
  ...
  @override
  int hash(LodgeRecord? e) => const ListEquality().hash([
        e?.image,
        e?.call,
        e?.title,
        e?.openTime,
  ...
  @override
  bool isValidKey(Object? o) => o is LodgeRecord;
}

...
class RecommendRecordDocumentEquality implements Equality<RecommendRecord> {
  const RecommendRecordDocumentEquality();

  @override
  bool equals(RecommendRecord? e1, RecommendRecord? e2) {
    ...
    return e1?.fishType == e2?.fishType &&
        ...
        listEquality.equals(e1?.seeUser, e2?.seeUser) &&
        e1?.more == e2?.more &&
  ...
  @override
  int hash(RecommendRecord? e) => const ListEquality().hash([
        e?.fishType,
        e?.location,
        e?.latlng,
        e?.title,
  ...
  @override
  bool isValidKey(Object? o) => o is RecommendRecord;
}

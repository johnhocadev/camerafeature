...
class PcommentsRecordDocumentEquality implements Equality<PcommentsRecord> {
  const PcommentsRecordDocumentEquality();

  @override
  bool equals(PcommentsRecord? e1, PcommentsRecord? e2) {
  ...
  @override
  int hash(PcommentsRecord? e) =>
      const ListEquality().hash([e?.userref, e?.txt, e?.updatetime, e?.pref]);

  @override
  bool isValidKey(Object? o) => o is PcommentsRecord;
}

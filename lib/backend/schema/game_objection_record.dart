...
class GameObjectionRecordDocumentEquality
    implements Equality<GameObjectionRecord> {
  const GameObjectionRecordDocumentEquality();

  @override
  bool equals(GameObjectionRecord? e1, GameObjectionRecord? e2) {
    return e1?.gameTitle == e2?.gameTitle &&
        e1?.gameDate == e2?.gameDate &&
  ...
  @override
  int hash(GameObjectionRecord? e) => const ListEquality().hash([
        e?.gameTitle,
        e?.gameDate,
        e?.gameTime,
        e?.gameR,
  ...
  @override
  bool isValidKey(Object? o) => o is GameObjectionRecord;
}

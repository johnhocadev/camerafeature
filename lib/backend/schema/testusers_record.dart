...
class TestusersRecordDocumentEquality implements Equality<TestusersRecord> {
  const TestusersRecordDocumentEquality();

  @override
  bool equals(TestusersRecord? e1, TestusersRecord? e2) {
  ...
  @override
  int hash(TestusersRecord? e) =>
      const ListEquality().hash([e?.users, e?.usersref]);

  @override
  bool isValidKey(Object? o) => o is TestusersRecord;
}
